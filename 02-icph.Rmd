...
| Diferencia de proporciones | No Aplica | No Aplica  | $\dfrac{p_1-p_2}{\sqrt{\hat{p}\hat{q}\left(\frac{1}{n_1}+\frac{1}{n_2}\right)}}$ <br> donde $\hat{p}=\dfrac{x_1+x_2}{n_1+n_2} \quad \hat{q}=1-\hat{p}$  | $Z$ |
