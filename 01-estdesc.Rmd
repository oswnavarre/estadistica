...
```
Los valores obtenidos para el máximo y el mínimo fueron $0$ y $1350$ respectivamente, por esta razón se decidió crear 10 clases y cada clase con una longitud de 150. Adicionalmente para obtener un gráfico agradable a la vista se cambia la orientación de las marcas en el eje $x$.  
