...
knitr::include_graphics("rnl.png")
```
...
```{r figura1, results='markup', echo=TRUE, message=FALSE, warning=FALSE, fig.cap="Histograma de las Ventas", fig.pos='h!'}
library(ggplot2)
...
```{r figura2, results='markup', echo=TRUE, message=FALSE, warning=FALSE, fig.cap="Histograma de las Ventas con Etiquetas en los Ejes", fig.pos='h!'}
library(ggplot2)
...
```{r figura3, echo=TRUE,fig.cap="Histograma de las Ventas de Acuerdo al Tamaño de la empresa", fig.pos='h!'}
...
```{r figura4, echo=TRUE,fig.cap="Diagrama de Caja de las Ventas según el Tamaño de la empresa",fig.pos='h!'}
...
```{r figura5, echo=TRUE,fig.cap="Diagrama de Caja de las Ventas de las Microempresas", fig.pos='h!'}
