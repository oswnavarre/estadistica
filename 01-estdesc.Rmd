...
```{r project1, out.width = "50%",fig.cap="Nuevo Proyecto. Paso 1",fig.align = 'center', echo=FALSE,fig.pos='h!'}
...
```{r project2, out.width = "50%",fig.cap="Nuevo Proyecto. Paso 2",fig.align = 'center', echo=FALSE,fig.pos='h!'}
...
```{r project3, out.width = "50%",fig.cap="Nuevo Proyecto. Paso 3",fig.align = 'center', echo=FALSE,fig.pos='h!'}
...
```{r project4, out.width = "50%",fig.cap="Nuevo Proyecto. Paso Final",fig.align = 'center', echo=FALSE,fig.pos='h!'}
...
```{r figura1, results='markup', echo=TRUE, out.width = "70%", message=FALSE, warning=FALSE, fig.cap="Histograma de las Ventas", fig.pos='h!'}
...
```{r figura3, echo=TRUE,out.width = "70%",fig.cap="Histograma de las Ventas de Acuerdo al Tamaño de la empresa", fig.pos='h!'}
...
```{r barras1, echo=TRUE,out.width = "70%",fig.cap="Gráfico de Barras de las empresas por Región", fig.pos='h!'}
...
```{r barras2, echo=TRUE,out.width = "70%",fig.cap="Gráfico de Barras de las empresas por Región (Ordenadas)", fig.pos='h!'}
ggplot(rank2018com, aes(x=REGIÓN)) + 
  geom_bar(stat = "count",col="black",fill="white") +
  xlab("") + ylab("Frecuencia")
```
...
```{r barras3, echo=TRUE, out.width = "70%",fig.cap="Gráfico de Barras de las empresas por Región y por Tamaño", fig.pos='h!'}
