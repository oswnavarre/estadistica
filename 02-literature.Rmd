...
Existen dos tipos de errores posibles en un procedimiento de prueba de hipótesis: rechazar la hipótesis nula cuando esta es verdadera y no rechazarla cuando esta es falsa. 

Tabla: (\#tab:nula) Error Tipo I y II
...
```{r pht, out.width = "60%",fig.cap="Errores Tipo I y II",fig.align = 'center', echo=FALSE}
