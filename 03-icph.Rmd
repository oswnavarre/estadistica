...
El intervalo con el $95\%$ de confianza para la media es $\left( 29074.58, 48737.94 \right)$. Si quisieramos calcular el intervalo con el $98\%$ de confianza cambiamos el argumento en la función `qnorm()` de $0.975$ a $0.99$.
