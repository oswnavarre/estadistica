...
como se puede observar en la ecuación \@ref(eq:normalpdf), la distribución normal tiene dos parámetros la media $\mu$ y la desviación $\sigma$, y se observan las siguientes propiedades de acuerdo a estos parámetros.
