...
```{r densidad, out.width = "60%", echo=FALSE,fig.cap="Curva de Densidad"}
...
```{r normal, out.width = "60%", echo=FALSE,fig.cap="Distribución Normal", fig.align='center'}
...
```{r normalmus, out.width = "60%", echo=FALSE,fig.cap="Diferentes distribuciones normales con diferentes medias", fig.align='center'}
...
```{r normalsds, out.width = "60%", echo=FALSE,fig.cap="Diferentes distribuciones normales con diferentes desviaciones", fig.align='center'}
...
```{r unasd, out.width = "50%", echo=FALSE,fig.cap="Porcentaje a 1 desviación de la media", fig.align='center'}
...
```{r dossd, out.width = "50%", echo=FALSE,fig.cap="Porcentaje a 2 desviaciones de la media", fig.align='center'}
...
```{r tressd, out.width = "50%", echo=FALSE,fig.cap="Porcentaje a 3 desviaciones de la media", fig.align='center'}
...
```{r normalz, out.width = "50%", echo=FALSE,fig.cap="Normal Estándar", fig.align='center'}
...
```{r tstudent, out.width = "50%", echo=FALSE,fig.cap="$t$ de Student", fig.align='center'}
...
```{r tz, out.width = "50%", echo=FALSE,fig.cap="$t$ de Student comparada con la Normal Estándar", fig.align='center'}
