...
Para ejemplificar la construcción de una tabla de frecuencias vamos a
trabajar con el archivo \texttt{Ranking2018Guayas.csv} este archivo
contiene todas las empresas de la provincia del Guayas. Se analizará la
relación entre la ciudad y el tamaño de las empresas.
...
\label{tab:tabla4}Tabla de Frecuencia de las Ventas
