...
{\centering \includegraphics[width=0.5\linewidth]{estadistica_files/figure-latex/rnl1-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{estadistica_files/figure-latex/figura1-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{estadistica_files/figure-latex/figura2-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{estadistica_files/figure-latex/figura3-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{estadistica_files/figure-latex/barras1-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{estadistica_files/figure-latex/barras2-1} 
...
\StringTok{  }\KeywordTok{group_by}\NormalTok{(TAMAÑO, REGIÓN)}\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{n=}\KeywordTok{n}\NormalTok{())}\OperatorTok{%>%}
\StringTok{  }\KeywordTok{spread}\NormalTok{(TAMAÑO, n) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{replace}\NormalTok{(., }\KeywordTok{is.na}\NormalTok{(.), }\DecValTok{0}\NormalTok{)}
...
{\centering \includegraphics[width=0.7\linewidth]{estadistica_files/figure-latex/barras3-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{estadistica_files/figure-latex/figura4-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{estadistica_files/figure-latex/figura5-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{estadistica_files/figure-latex/densidad-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{estadistica_files/figure-latex/normal-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{estadistica_files/figure-latex/normalmus-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{estadistica_files/figure-latex/normalsds-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{estadistica_files/figure-latex/figura6-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{estadistica_files/figure-latex/figura7-1} 
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(TAMAÑO }\OperatorTok{==}\StringTok{ "MICROEMPRESA"}\NormalTok{) }\OperatorTok{%>%}
...
\CommentTok{## [1] 29074.58 48737.94}
...
\CommentTok{## [1] 27236.71 50575.81}
\CommentTok{## attr(,"conf.level")}
\CommentTok{## [1] 0.98}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{## [1] 29039.57 48772.96}
\CommentTok{## attr(,"conf.level")}
\CommentTok{## [1] 0.95}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{## [1] 30632.78 47179.74}
\CommentTok{## attr(,"conf.level")}
\CommentTok{## [1] 0.9}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(TAMAÑO }\OperatorTok{==}\StringTok{ "PEQUEÑA"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(ACTIVO)}
...
{\centering \includegraphics[width=0.5\linewidth]{estadistica_files/figure-latex/corr3-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{estadistica_files/figure-latex/vtaspub-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{estadistica_files/figure-latex/centroide-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{estadistica_files/figure-latex/regre1-1} 
...
\StringTok{  }\KeywordTok{select}\NormalTok{(UTILIDAD,EMPLEADOS,VENTAS,TAMAÑO)}
...
{\centering \includegraphics[width=0.6\linewidth]{estadistica_files/figure-latex/pairs-1} 
